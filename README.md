...
面向**实习 / 校招 / 社招**的大厂信息资源站：检索 20 家 AI 大模型厂的
**JD 画像、团队背景图谱、简历策略、招聘入口、核心产品调研**，并细化每家的**近期进展（发布的大模型 / 产品）**与**目前的技术架构**，
方便面试前快速摸清业务线、做简历定制。

> 梯队划分：第一梯队大厂（BAT + 新 BAT：字节 / 腾讯 / 阿里 / 百度 / 京东 / 快手 / 美团）｜第二梯队独角兽（智谱 / Kimi / DeepSeek / MiniMax / 百川 / 商汤 / 阶跃星辰）｜第三梯队中小厂（宇树 / 智元 / 银河通用 / 星海图 / 星动纪元 / 灵初智能）。
